<?php
    ...
    if (mysqli_num_rows($login) >0 ) {
        ...
        if($password==$password_confirm){
            ...
            $login1 = mysqli_query($conn,"INSERT INTO medico VALUES(NULL,'$password','$nome','$apelidos','$sexo',$telefone,'$email',$nif,'$morada','$codigo_postal','Portugal',$codigo_localidade,$codigo_tipo_conta,1);");
