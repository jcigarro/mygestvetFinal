...
$sql5 = "SELECT * FROM cliente, localidade WHERE cliente.Codigo_Localidade=localidade.Codigo_Localidade AND Numero_Medico = $id_medico;";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="#edit<?php echo $Numero_Cliente;?>" data-toggle="modal">
                           ...
                           <a target="_blank" href="https://www.google.com/maps/place/<?php echo $loca_desc;?>" >
                        ...
                        <div id="edit<?php echo $Numero_Cliente; ?>"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left"  role="dialog">
                          ...
                          <!--Delete Modal -->
                          <div id="delete<?php echo $Numero_Cliente; ?>" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <form method="post">
                                <!-- Modal content-->
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <input type="hidden" name="delete_id" value="<?php echo $Numero_Cliente; ?>">
                                    <div class="alert alert-danger">Tem a certeza que pretende eliminar o cliente <strong> <?php echo $Nome; ?>? </strong>
                                    </div>
                                    <div class="modal-footer">
