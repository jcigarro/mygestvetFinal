...
if(!(isset($_SESSION['email_cod']) && $_SESSION['email_cod'] != "") || $_SESSION['tipo_conta'] != 2){
  ...
  $sql = "SELECT * from medico where Email = '$email';";
      ...
      $query5 = "SELECT medico.Numero_Medico, COUNT(*) as quantidade_servicos FROM exame_clinico, animal, cliente, medico WHERE cliente.Numero_Medico=medico.Numero_Medico AND animal.Numero_Cliente=cliente.Numero_Cliente AND exame_clinico.Numero_Animal=animal.Numero_Animal AND medico.Numero_Medico=$Numero_Medico GROUP BY medico.Numero_Medico";
            ...
            <div class="container-fluid">
                <div class="card">
                  <div class="card-header">
                      <h3 class="h4">Eventos Futuros</h3>
                  </div>
                  <div class="card-body">
                      ...
                      <table id="datatable1" style="width: 100%;" class="table">
                          ...
                          <tbody>
                              <?php 
                                  ...
                                  $sql1 = "SELECT agenda.title, agenda.start, agenda.end FROM agenda, medico, tipo_conta WHERE agenda.Numero_Medico=medico.Numero_Medico and medico.Codigo_Tipo_Conta=tipo_conta.Codigo_Tipo_Conta and tipo_conta.Codigo_Tipo_Conta='2' and  medico.Numero_Medico=$Numero_Medico and agenda.start >now()";
