                            ...
                            <div class="form-group mb-4">
                              <div class="form-group">
                                <form action=" " method='post' >
                                  ...
                                  <input type="text" onkeydown="limpaCampo()" onkeyup="procuraRegisto(this.value)" id="valorReg" name="valorReg" placeholder="Nome do animal:" required>
                                </div>
                              </form>
                               <?php
                            ...
                            <div class="col-sm-6 col-md-6">
                              <div class="form-group mb-4">
                                <div class="tab">
                                  ...
                                  <div class="form-group">
                                    <h4 style="font-size: 14px; color: #5d998c">Número de Consulta Selecionado:</h4>
                                  ...
                                  <!-- One "tab" for each step in the form: -->
                                    ...
                                    <div class="form-group">
                                      ...
                                      <textarea rows="2" cols="60" type="text" placeholder="História Clínica" name="fname"></textarea>
                                    </div>
                                    <div class="form-group">
                                      <label class="form-control-label">Anamnese:</label>
                                      <textarea rows="2" cols="60" type="text" placeholder="Anamnese" name="lname"></textarea>
                                    </div>
                                    <div class="form-group">
                                      <label class="form-control-label">Diagnóstico:</label>
                                      <textarea rows="2" cols="60" type="text" placeholder="Diagnóstico" name="diagnostico"></textarea>
                                    </div>
                                    <div class="form-group">
                                      <label class="form-control-label">Tratamento:</label>
                                      <textarea rows="2" cols="60" type="text" placeholder="Tratamento" name="tratamento"></textarea>
                                    </div>
                  <div class="form-group">
                                      <label class="form-control-label">Outras Informações:</label>
                                      <textarea rows="2" cols="60" name="outrasInformacoes" type="text" placeholder="Outras informações" ></textarea>
                                    </div>
                                  </div>
