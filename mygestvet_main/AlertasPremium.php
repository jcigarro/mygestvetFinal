      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <div class="sidebar-header d-flex align-items-center"><a href="PerfilMédicoPremium.php">
              <div class="avatar"><img src="uploads/<?php echo $foto_perfil9;?>" alt="..." class="img-fluid rounded-circle"></div></a>
            <div class="title">
         ...
         <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Notificações</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Ver todas as Notificações</li>
            </ul>
          </div>
          <!-- Forms Section-->
          <section>
