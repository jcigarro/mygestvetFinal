...
$sql6 = 'UPDATE agenda SET start="'.$inicio.'", end="'.$fim.'" WHERE id='.$id.'';
...
$Vai 		= "Caro(a) $Nome, Informamos que a consulta do dia $start_update com o seu animal $Nome_Animal foi alterada para o dia $inicio.\n Obrigada,\n A Equipa MyGestVet.";


$Vai1 		= "Caro(a) $nome_medico, Informamos que a consulta do dia $start_update com o animal $Nome_Animal pertencente ao cliente $Nome, foi alterada para o dia $inicio.\n Obrigada,\n A Equipa MyGestVet.";
